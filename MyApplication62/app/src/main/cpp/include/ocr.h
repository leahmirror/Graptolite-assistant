...
class OCR
{
    public:
        OCR();
        string detect(cv::Mat im_bgr);

    int init(AAssetManager *pManager, string basicString, string basicString2);
...
private:
        ...
        //const float mean_vals_pse_angle[3] = {103.94f, 116.78f, 123.68f};
        //const float norm_vals_pse_angle[3] = {1/0.229f/255.f, 1/0.224f/255.f, 1/0.225f/255.f};
