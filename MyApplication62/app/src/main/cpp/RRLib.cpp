...
namespace RRLib {
    ...
    //----------------------------------------------------------
    void copyToRotRectImg( cv::RotatedRect rr, Mat &src, Mat &M, Mat &rotate, Mat& dst)
    {
        ...
        warpAffine(src, rotate, M, src.size(), INTER_CUBIC);
        // crop the resulting image
        getRectSubPix(rotate, rect_size, rr.center, dst);
    }
    //----------------------------------------------------------
