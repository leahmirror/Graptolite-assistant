...
public class MeituView extends View {
    ...
    public boolean setBitmapRect(Rect rect) {
       ...
       // mOrigBitmap = mOrigBitmap.copy(Bitmap.Config.ARGB_8888, true);
        mCropBitmap = Bitmap.createBitmap(mOrigBitmap,mRect.left, mRect.top, mRect.right, mRect.bottom);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Rect rect = new Rect(mRect.left, mRect.top,mRect.left+mCropBitmap.getWidth(), mRect.top+mCropBitmap.getHeight());
        Paint paint = new Paint();
        //设置边框颜色
